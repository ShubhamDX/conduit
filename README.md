...
4. **Orchestrator-owned shared memory** — agents receive a scoped memory reference and can request context on demand, while redacted run summaries are written back for later agents.
